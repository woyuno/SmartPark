...
const UserList = lazy(() => import('../page/users/users'))
...
const Repair = lazy(() => import('../page/repair/reapir'))
...
const Merchants = lazy(() => import('../page/merchants/merchants'))
...
const Equipment = lazy(() => import('../page/equipment/equipment'))
const Enengy = lazy(() => import('../page/energy/energy'))
const Settings = lazy(() => import('../page/settings/settings'))
const Personal = lazy(() => import('../page/personal/personal'))
